  ...
  return (
    <div className="pt-28 pb-20 px-6 md:px-12 bg-brand-bg text-brand-ink min-h-screen">
      <div className="max-w-[1600px] mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 border-t border-brand-line pt-12">
          
          {/* Step 1 */}
          <div className="space-y-4 flex flex-col items-center text-center relative group">
            ...
            <div className="relative w-full flex justify-center py-4">
              {/* Connected Arrow line for desktop */}
            ...
            <div className="text-xs md:text-sm text-brand-ink-soft leading-relaxed space-y-2">
          ...
          <div className="space-y-4 flex flex-col items-center text-center relative group">
            ...
            <div className="relative w-full flex justify-center py-4">
              ...
              <div className="w-[180px] h-[180px] rounded-full border border-brand-line bg-brand-bg-alt flex items-center justify-center p-6 text-center shadow-[inset_0_0_20px_rgba(59,130,246,0.03)]">
                <div className="font-mono text-xs leading-normal tracking-wide text-brand-ink uppercase font-bold">
          ...
          {/* Step 5 */}
          <div className="space-y-4 flex flex-col items-center text-center relative">
            <div className="font-mono text-xs tracking-[0.05em] uppercase font-bold text-brand-blue min-h-[30px] flex items-center justify-center">
        ...
        <div className="border border-brand-line rounded-xl py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 bg-brand-bg">
          ...
          <div className="px-8 border-b md:border-b-0 lg:border-r border-brand-line py-8 md:py-0">
            ...
            <ul className="text-xs md:text-sm text-brand-ink-soft space-y-3">
          ...
          {/* Panel 4 (Mini Flow) */}
          <div className="px-8 border-b md:border-b-0 border-brand-line py-8 md:py-0 md:col-span-2 lg:col-span-1 lg:border-r">
            <h3 className="font-mono text-xs tracking-[0.08em] font-bold text-brand-blue uppercase flex items-center gap-2 mb-6">
            ...
            <div className="grid grid-cols-3 gap-y-4 gap-x-2">
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-blue font-bold">OBSERVE</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We see moments.</p>
              </div>
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-teal font-bold">PATTERN</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We connect signals.</p>
              </div>
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-blue font-bold">UNDERSTAND</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We map the mind.</p>
              </div>
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-orange font-bold">PREDICT</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We anticipate need.</p>
              </div>
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-violet font-bold">DESIGN</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We build systems.</p>
              </div>
              <div className="text-center space-y-1">
                <span className="font-mono text-xs text-brand-green font-bold">POTENTIAL</span>
                <p className="text-xs text-brand-ink-soft leading-normal">We unlock ability.</p>
              </div>
            </div>
          </div>
